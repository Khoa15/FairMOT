...
if __name__ == '__main__':
    data_val = '/content/drive/MyDrive/datasets/FairMOT/crowdhuman/images/val'
    label_val = '/content/drive/MyDrive/datasets/FairMOT/crowdhuman/labels_with_ids/val'
    ann_val = '/content/drive/MyDrive/datasets/FairMOT/crowdhuman/annotation_val.odgt'
    data_train = '/content/drive/MyDrive/datasets/FairMOT/crowdhuman/images/train'
    label_train = '/content/drive/MyDrive/datasets/FairMOT/crowdhuman/labels_with_ids/train'
    ann_train = '/content/drive/MyDrive/datasets/FairMOT/crowdhuman/annotation_train.odgt'
