...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--data_dir', type=str, default='/content/drive/MyDrive/datasets/FairMOT')
  ...
  def init(self, args=''):
    default_dataset_info = {
      'mot': {'default_resolution': [608, 1088], 'num_classes': 80,#original numclasses: 1
